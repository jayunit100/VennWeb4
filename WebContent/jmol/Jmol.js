...
function _jmolGetJarFilename(fileNameOrFlag) {
  _jmol.archivePath =
    (typeof(fileNameOrFlag) == "string"  ? fileNameOrFlag : (fileNameOrFlag ?  "JmolAppletSigned" : "JmolAppletSigned") + "0.jar");
}
...
function _jmolSetCodebase(codebase)
{
  ...
  if (_jmol.debugAlert)
    alert("jmolCodebase is =" + _jmol.codebase);
...
function _jmolLoadModel(targetSuffix,remoteURL,array,isError,errorMessage){
 ...
 if(isError)alert("error"+errorMessage)
...
function screenshot()
{
	//alert("hi");
	 ...
	 //alert(image);
	 	document.getElementById("imageDiv").innerHTML ='<img src="data:image/jpeg;base64,'+image+'">'		
}
